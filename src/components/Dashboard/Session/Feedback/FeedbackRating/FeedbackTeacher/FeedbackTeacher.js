        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.ButtonsContainer}>
                    <Button mode="contained" style={{alignSelf:'center'}} color='green' width="90%" onPress={this.props.Confirm}>
                        Confirm
                    </Button>
                    <View style={{paddingVertical: 5}}/>
                    <Button mode='contained' style={{alignSelf:'center'}} width="90%" color='red' onPress={this.props.resetAll}>
                        Reset
                    </Button>
                </View>
            </View>
